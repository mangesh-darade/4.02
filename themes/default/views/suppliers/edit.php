            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group person">
                        <?= lang("name", "name"); ?>
                        <?php echo form_input('name', $supplier->name, 'class="form-control tip" id="name" required="required" data-bv-notempty="true" onkeypress="return onlyAlphabets(event,this);" type="text" ondrop="return false;" onpaste="return false;"'); ?>  
                   ...
                   <div class="form-group">
                       ...
                       <?php echo form_input('gstn_no', $supplier->gstn_no, 'class="form-control" id="gstn_no"  onchange="return validateGstin();"'); ?>
                   </div>
                    <!--<div class="form-group company">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control" 
                               value="<?= $supplier->email ?>"  id="email_address" data-bv-emailaddress
        data-bv-onerror="onFieldError" data-bv-onsuccess="onFieldSuccess" data-bv-onstatus="onFieldStatus"/>
                    </div>
                    <div class="form-group">
                        <?= lang("phone", "phone"); ?>
                         <input type="tel" name="phone" class="form-control"  value="<?= $supplier->phone ?>"  data-bv-phone="true" data-bv-phone-country="US" maxlength="10" id="phone" onkeypress="return IsNumeric(event)" ondrop="return false" onpaste="return false"/>
                    ...
                    <div class="form-group">
                        <?= lang("city", "city"); ?>
                        <?php echo form_input('city', $supplier->city, 'class="form-control" id="city"  onkeypress="return onlyAlphabets1(event,this);" type="text" '); ?>
...
<?php echo $this->sma->dbSavedValue($st,$supplier->state);?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?php echo form_input('postal_code', $supplier->postal_code, 'class="form-control" id="postal_code" maxlength="6"  onkeypress="return IsNumeric1(event)" ondrop="return false"'); ?>
                        <span id="errorp" style="color:#a94442; display: none;font-size:11px;">please enter numbers only</span>
                    </div>
                    <div class="form-group">
                        <?= lang("country", "country"); ?>
                         <?php echo form_input('country', $supplier->country, 'class="form-control" id="country" onkeypress="return onlyAlphabets3(event,this);" type="text" ondrop="return false;" onpaste="return false;"'); ?>
