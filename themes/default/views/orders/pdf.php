...
<div id="wrap">
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php } ?>
            <div class="col-sm-12">
                <h3 class="bold" style="text-align: center;"><?= $this->Settings->order_receipt_label ? $this->Settings->order_receipt_label : 'Order' ?> Recept</h3>
                <table class="table">
                    <tr>
                        <td class="bold"><?= $this->Settings->order_receipt_label ? $this->Settings->order_receipt_label : 'Order' ?> No.: <?= lang($inv->invoice_no ); ?>
