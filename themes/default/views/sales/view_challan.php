                ...
                <div id="receipt-data" style="font-size: <?php echo $font_size; ?>pt !important">
                    ...
                    <div class="text-center">
                        ...
                        if ($Settings->invoice_view == 1) {
                            ...
                            <div class="col-sm-12 text-center">
                                <h5 style="font-weight:bold; margin: 0px;"><?= $this->Settings->order_receipt_label ? $this->Settings->order_receipt_label : 'Order' ?></h5>
                            </div>
                    <hr/>
                            <?php
                        }
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="pull-left"><?= $this->Settings->order_receipt_label ? $this->Settings->order_receipt_label : 'Order' ?> No. : <?= $inv->invoice_no; ?>
...
//                                     echo '<td>' . (($payment->pos_balance >= 0) ? lang("balance") . ':&nbsp;' : lang("change") . ':&nbsp;') . $this->sma->formatMoney($payment->pos_balance) . '</td>';
                        ...
                        if ($Settings->invoice_view == 1) {
                           echo $resTaxTbl = $this->sma->taxInvvoiceTabel($tax_summary, $taxItems, $inv, $return_sale, $Settings, 1);
                        }
                        ?>
