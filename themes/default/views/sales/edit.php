    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("sales/".$formaction."/" . $inv->id, $attrib)
                ?>
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="panel-body" style="padding: 5px;">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <?php $sst = array('pending' => lang('pending'), 'partial' => lang('partial'), 'delivered' => lang('delivered'));
                                            echo form_dropdown('delivery_status', $sst, '', 'class="form-control input-tip" required="required" id="sldelivery_status"');
                                            ?>
                                        </div>
                                    </div>
                                </div>
...
<!--                                            <th class="col-md-1 delivery_items"><?= lang("delivered"); ?></th>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php if($eshop_sale==1)
								$sst = array('pending' => lang('pending'), 'completed' => lang('completed'), 'processing'=> lang('processing'),'cancelled'=> lang('cancelled'));
							else
