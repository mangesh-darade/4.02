...
class Products_model extends CI_Model
{
    ...
    public function getQASuggestions($term, $limit = 5,$warehouse_id)
    {
    ...
    public function getCategories($parent_id=null,$param=null) { 
        ...
        $this->db->select('id , code ,name ,image ,id as cat_id,(select count(*) from sma_categories where parent_id=cat_id) as subcat_count ,IF(parent_id IS NULL,0,parent_id) as parent_id ');
