    ...
    function import_csv() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (isset($_FILES["userfile"])) {
                ...
                $keys = array('name', 'code', 'divisionid', 'article_code', 'barcode_symbology', 'brand', 'category_code', 'unit', 'sale_unit', 'purchase_unit', 'cost', 'price', 'alert_quantity', 'tax_rate', 'tax_method', 'image', 'subcategory_code', 'variants', 'mrp', 'hsn_code', 'warehouse', 'cf1', 'cf2', 'cf3', 'cf4', 'cf5', 'cf6');
